...
cap = cv2.VideoCapture("twicecaseone.mp4")
f = 25
w = int(1000/(f-1))
print(w)
...
while True:
    ...
    for cnt in contours:
        ...
        if area > 8000:
            ...
            if visited is False:
                cv2.putText(roi, "HEAVY", (x, y + 50), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 2)
                visited = True
            ...
            if visited is False:
                cv2.putText(roi, "LIGHT", (x, y + 50), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 2)
                visited = True;
            detections.append([x,y,w,h])
    ...
    for box_id in boxes_ids:
        ...
        if(tracker.getsp(id)<tracker.limit()):
            cv2.putText(roi,"CAR_ID->"+str(id)+" SPEED->"+str(tracker.getsp(id)),(x,y-15), cv2.FONT_HERSHEY_PLAIN,1,(255,255,0),2)
            cv2.rectangle(roi, (x, y), (x + w, y + h), (0, 255, 0), 3)
        else:
            cv2.putText(roi,"CAR_ID->"+str(id)+ " SPEED->"+str(tracker.getsp(id)),(x, y-15),cv2.FONT_HERSHEY_PLAIN, 1,(0, 0, 255),2)
    ...
    cv2.line(roi, (0, 410), (960, 410), (0, 0, 255), 2)  # (roi, (0, 410), (960, 410), (0, 0, 255), 2)
    cv2.line(roi, (0, 430), (960, 430), (0, 0, 255), 2)  # (roi, (0, 430), (960, 430), (0, 0, 255), 2)

    cv2.line(roi, (0, 235), (960, 235), (0, 0, 255), 2)  # (roi, (0, 235), (960, 235), (0, 0, 255), 2) changed
    cv2.line(roi, (0, 255), (960, 255), (0, 0, 255), 2)  # (roi, (0, 255), (960, 255), (0, 0, 255), 2) changed
